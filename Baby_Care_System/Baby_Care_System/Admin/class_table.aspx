<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="class_table.aspx.cs" Inherits="Baby_Care_System.Admin.class_table" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Classes Table</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Classes Table</h4>
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txtcnm" runat="server" CssClass="form-control form-control-line" ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txtag" runat="server" CssClass="form-control form-control-line" ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txttim" runat="server" CssClass="form-control form-control-line" ></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <asp:TextBox ID="txtexp" runat="server" CssClass="form-control form-control-line" ></asp:TextBox>
                                            
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-md-12">Demo Image</label>
                                        <div class="col-md-12">
                                            <asp:FileUpload ID="imgdem" runat="server" CssClass="form-control form-control-line" />
                                           
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Teacher Image</label>
                                        <div class="col-md-12">
                                            <asp:FileUpload ID="imgtch" runat="server" CssClass="form-control form-control-line" />
